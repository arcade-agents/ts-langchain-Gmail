...
const TOOLS_WITH_APPROVAL = ['Gmail_ChangeEmailLabels', 'Gmail_CreateLabel', 'Gmail_DeleteDraftEmail', 'Gmail_ReplyToEmail', 'Gmail_SendDraftEmail', 'Gmail_SendEmail', 'Gmail_TrashEmail', 'Gmail_UpdateDraftEmail', 'Gmail_WriteDraftEmail', 'Gmail_WriteDraftReplyEmail'];
